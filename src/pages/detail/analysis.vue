<template>
  <div class="sales-board">
      ...
      <my-dialog :is-show="isShowPayDialog" @on-close="hidePayDialog">
        <!--<table></table>是表格标签；
<tr></tr>是表格的行标签，每一组标签表示一行；内可以嵌套多个<td></td>和<th></th>；
<td>指表格数据<table data>，即数据单元格内容，每一组标签表示一个单元格，嵌套于<tr>内；
<th>指表格表头<table header>，于数据单元格类似，每一组标签表示一个单元格，嵌套于<tr>内，区别在于<th>里的内容以粗体表示。-->
        ...
        <!--上述的table部分的每个页面对应的显示不一样，但是下面的银行显示一样，
        所以直接用一个组件bankchooser-->
